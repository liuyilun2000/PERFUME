...
#SBATCH --job-name=Mixtral-8x7B.lora_8.4-2.train
#SBATCH --output=log/Mixtral-8x7B.lora_8.4-2.train.slurm.log
...
python finetune.py \
    ...
    --output_dir 'checkpoints/Mixtral-8x7B-v0.1.lora_8.4-2' \
    ...
    --wandb_run_name 'Mixtral-8x7B.lora_8.4-2' \
    | tee -a log/Mixtral-8x7B.lora_8.4-2.train.log
