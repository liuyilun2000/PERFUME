...
#SBATCH --job-name=OLMoE-1B-7B.lora.2-2.train
#SBATCH --output=log/OLMoE-1B-7B.lora.2-2.%j.train.slurm.log
#SBATCH --mail-type=ALL


declare -a configs=(
    "4 8 OLMoE-1B-7B.lora_4.2-2"
    "8 16 OLMoE-1B-7B.lora_8.2-2"
    "16 32 OLMoE-1B-7B.lora_16.2-2"
    "32 64 OLMoE-1B-7B.lora_32.2-2"
)
...
run_training() {
    ...
    python finetune.py \
        ...
        --output_dir "checkpoints/OLMoE-1B-7B-0924.lora_${lora_r}.2-2" \
