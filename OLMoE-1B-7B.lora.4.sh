...
#SBATCH --job-name=OLMoE-1B-7B.lora.4.train
#SBATCH --output=log/OLMoE-1B-7B.lora.4.%j.train.slurm.log
#SBATCH --mail-type=ALL


declare -a configs=(
    "4 8 OLMoE-1B-7B.lora_4.4"
    "8 16 OLMoE-1B-7B.lora_8.4"
    "16 32 OLMoE-1B-7B.lora_16.4"
    "32 64 OLMoE-1B-7B.lora_32.4"
)
...
run_training() {
    ...
    python finetune.py \
        ...
        --output_dir "checkpoints/OLMoE-1B-7B-0924.lora_${lora_r}.4" \
        --batch_size 16 --micro_batch_size 16 --num_epochs 3 \
        --learning_rate 1e-5 --cutoff_len 256 --val_set_size 120 \
        --eval_step 80 --save_step 80 \
        --shared_adapter True  --shared_adapter_num 4 \
