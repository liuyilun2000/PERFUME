...
#SBATCH --job-name=OLMoE-1B-7B.lora.2.train
#SBATCH --output=log/OLMoE-1B-7B.lora.2.%j.train.slurm.log
#SBATCH --mail-type=ALL


declare -a configs=(
    "4 8 OLMoE-1B-7B.lora_4.2"
    "8 16 OLMoE-1B-7B.lora_8.2"
    "16 32 OLMoE-1B-7B.lora_16.2"
    "32 64 OLMoE-1B-7B.lora_32.2"
)
...
run_training() {
    ...
    python finetune.py \
        ...
        --output_dir "checkpoints/OLMoE-1B-7B-0924.lora_${lora_r}.2" \
        --batch_size 16 --micro_batch_size 16 --num_epochs 3 \
        --learning_rate 1e-5 --cutoff_len 256 --val_set_size 120 \
        --eval_step 80 --save_step 80 \
        --shared_adapter True  --shared_adapter_num 2 \
