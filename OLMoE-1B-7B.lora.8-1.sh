...
#SBATCH --job-name=OLMoE-1B-7B.lora.8-1.train
#SBATCH --output=log/OLMoE-1B-7B.lora.8-1.%j.train.slurm.log
#SBATCH --mail-type=ALL


declare -a configs=(
    "4 8 OLMoE-1B-7B.lora_4.8-1"
    "8 16 OLMoE-1B-7B.lora_8.8-1"
    "16 32 OLMoE-1B-7B.lora_16.8-1"
    "32 64 OLMoE-1B-7B.lora_32.8-1"
)
...
run_training() {
    ...
    python finetune.py \
        ...
        --output_dir "checkpoints/OLMoE-1B-7B-0924.lora_${lora_r}.8-1" \
